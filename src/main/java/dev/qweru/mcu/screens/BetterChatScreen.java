...
public class BetterChatScreen
    ...
    public BetterChatScreen(String originalChatText) {
    ...
    protected void init() {
        ...
        this.chatField = new TextFieldWidget(this.client.advanceValidatingTextRenderer, this.width-30, this.height - 30, 28, 28, (Text)Text.translatable("chat.editBox")){
        };
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        ...
        if (!net.minecraft.client.gui.screen.ChatScreen.hasShiftDown()) {
            amount *= 7.0;
        }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        net.minecraft.client.gui.screen.ChatScreen.fill(matrices, 2, this.height - 14, this.width - 2, this.height - 2, this.client.options.getTextBackgroundColor(Integer.MIN_VALUE));
